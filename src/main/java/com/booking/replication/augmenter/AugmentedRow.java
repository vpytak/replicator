...
public class AugmentedRow {
    ...
    public String toString() {
        return "AugmentedRow{" +
                "eventV4Header=" + eventV4Header +
                ", binlogFileName='" + binlogFileName + '\'' +
                ", rowBinlogEventOrdinal=" + rowBinlogEventOrdinal +
                ", tableName='" + tableName + '\'' +
                ", rowUUID='" + rowUUID + '\'' +
                ", rowBinlogPositionID='" + rowBinlogPositionID + '\'' +
                ", rowPseudoGTIDPositionID='" + rowPseudoGTIDPositionID + '\'' +
