...
public class DeleteRowsEventHandler implements RawBinlogEventHandler {
    ...
    @Override
    public void apply(RawBinlogEvent binlogEventV4, CurrentTransaction currentTransaction) throws EventHandlerApplyException, TableMapException, ApplierException, IOException {
